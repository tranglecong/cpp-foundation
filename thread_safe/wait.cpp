...
bool Wait::isExit() const { return m_exit; }

bool Wait::internalPred() const { return !m_internal_pred_flag; }
...
Wait::Status Wait::wait() {
    ...
    m_condition.wait(lock, [this]() -> bool { return isExit() || internalPred(); });
    if (isExit()) {
        return Status::EXIT;
    }
